...
\begin{equation}
Info(D) = -\frac{p}{p+n}\log_2(\frac{p}{p+n})-\frac{n}{p+n}\log_2(\frac{n}{p+n})(\#eq:ID3-1)
\end{equation}
...
\end{aligned}
$$
从而在 bag 的水平下， information gain of A on D，即公式\@ref(eq:ID3-2)改写如下
$$
\begin{aligned}
